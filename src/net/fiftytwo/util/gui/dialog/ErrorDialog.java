 ...
 * ErrorDialog.java
 *
 * Created on October 1, 2002, 11:22 PM
 */

package net.fiftytwo.util.gui.dialog;

import net.fiftytwo.util.gui.State;
import net.fiftytwo.util.gui.OnScreenPopupMenu;
import net.fiftytwo.util.gui.DocumentOutputStream;
...
{
    /**
     * Opens an ErrorDialog with no help button and no displayed Throwable.
    ...
    /**
     * Opens an ErrorDialog that has a Help button that opens the specified topic.  Help books
     ...
     */
    public ErrorDialog(JFrame parent, String message, String helpTopic)
    {
        this(parent, message, null, helpTopic);
    }
    /**
     * Opens an ErrorDialog that displays a Throwable, but has no help button.  Book objects
     ...
     */
    public ErrorDialog(JFrame parent, String message, Throwable throwable)
    {
        this(parent,message,throwable,null);
    }
    /**
     * Opens an ErrorDialog that displays a Throwable and has a Help button
     ...
     */
    public ErrorDialog(JFrame parent, String message, Throwable throwable, String helpTopic)
    {
    ...
    /** Inherited from Dialog; do not call. */
    final protected void enableApply(State state)
    {
    ...
    {
      // We used to use a Dialog here, but it needs a Frame as its parent.
